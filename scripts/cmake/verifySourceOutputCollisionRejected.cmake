...
if(COLLISION_KIND STREQUAL "OUTPUT")
    ...
    set(command "${JOYEER_EXECUTABLE}" -g0 -o "${input_file}" "${input_file}")
elseif(COLLISION_KIND STREQUAL "LLVM")
    set(input_file "${TEST_DIRECTORY}/protected-llvm-source.joyeer")
    set(command "${JOYEER_EXECUTABLE}" --emit-llvm "${input_file}" "${input_file}")
elseif(COLLISION_KIND STREQUAL "PDB")
    ...
    set(command "${JOYEER_EXECUTABLE}" -gcodeview -o "${output_file}" "${input_file}")
elseif(COLLISION_KIND STREQUAL "PDB_NODEBUG")
    ...
    set(command "${JOYEER_EXECUTABLE}" -g0 -o "${output_file}" "${input_file}")
else()
